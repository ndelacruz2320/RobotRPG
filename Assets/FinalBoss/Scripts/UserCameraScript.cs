...
public class UserCameraScript : MonoBehaviour
{
            ...
            else
            {
                if (Input.GetMouseButton(1))
                {
                    ...
                    if (allowMouseInputX)
                        ...
                        fireSpawn.eulerAngles = new Vector3(fireSpawn.eulerAngles.x, xDeg, 0f); //@@@@
                    if (allowMouseInputY)
                        yDeg -= Input.GetAxis("Mouse Y") * ySpeed * 0.02f;
                        fireSpawn.eulerAngles = new Vector3(yDeg, fireSpawn.eulerAngles.y, 0f);
