...
public class BlowerFixIt : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //sprint("Excavator arraynum" + ArrayNum);
    ...
    private IEnumerator RockThrow()
    {
        while (Health > 0)
        {
            fireRotation.eulerAngles = new Vector3(0f, fireRotation.eulerAngles.y + 45f, 0f);
            Instantiate(Attack, attackSpawn.transform.position, fireRotation);
            fireRotation.eulerAngles = new Vector3(0f, fireRotation.eulerAngles.y - 90f, 0f);
            Instantiate(Attack, attackSpawn2.transform.position, fireRotation);
